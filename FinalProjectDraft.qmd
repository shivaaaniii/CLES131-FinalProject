...
We want the averages of each country, so we need to make a new dataframe using our cleaned data.
...
scatter <- importCoral |>
  ...
  labs(title="Percent Bleaching vs US Plastic Imports (2002-2020)",
       subtitle="Hover over points to see Year and Specific Values")
