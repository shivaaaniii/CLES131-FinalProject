---
title: "CLES 131 Final Project: Marine Plastics"
format: html
---
...
2.  [US Plastic Exports](#exports)

-   2.1 [Sums of Plastic Exports](#sum)
-   2.2 [Change Over Time](#time)
-   2.3 [Difference in 2025](#2025)

3.  [Quality of Life](#quality)

-   3.1 [Combining Data](#combine)
-   3.2 [Plotting the Data](#plot)
-   3.3 [Surprising Regressions!](#reg)

4.  [Coral Bleaching](#bleaching)

-   4.1 [Bleaching Data](#stats)
-   4.2 [Bleaching per Country](#country)

5.  [Relation to Plastic Imports](#imports)

-   5.1 [Bleaching vs Plastic](#bleach-plastic)
-   5.2 [Regression](#reg2)
...
# US Plastic Exports {#plastic}

## Sums of Plastic Exports {#sum}
...
![Spatial Extent of the Data](data/bleachingArea.png)
...
# Relation to Plastic Imports {#imports}

## Bleaching vs Plastic {#bleach-plastic}
